...
#        self.device_index.setCurrentIndeces(device_index,deviceoutputref)
        ...
        v = StrictDoubleValidator(0, popupcad.gui_positive_infinity, popupcad.gui_default_decimals,self.support_width)
        ...
        v = StrictDoubleValidator(0, popupcad.gui_positive_infinity, popupcad.gui_default_decimals,self.support_out)
        ...
        v = StrictDoubleValidator(0, popupcad.gui_positive_infinity, popupcad.gui_default_decimals,self.hole_radius)
        ...
        v = StrictDoubleValidator(0, popupcad.gui_positive_infinity, popupcad.gui_default_decimals,self.cut_width)
...
class CustomSupport3(Operation):
    ...
    def generate(self, design):
        ...
        modified_device, supports, cuts = popupcad.algorithms.modify_device.modify_device(device, support, self.support_width *popupcad.csg_processing_scaling, self.support_out *popupcad.csg_processing_scaling, self.hole_radius * popupcad.csg_processing_scaling, self.cut_width * popupcad.csg_processing_scaling)
    ...
    def upgrade(self, *args, **kwargs):
        ...
        operation_links = {
            'device': [
                (self.device_link, self.deviceoutputref)]}
