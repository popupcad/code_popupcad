...
#        self.device_index.setCurrentIndeces(device_index,deviceoutputref)
        ...
        v = StrictDoubleValidator(0, popupcad.gui_positive_infinity, popupcad.default_gui_rounding,self.support_width)
        ...
        v = StrictDoubleValidator(0, popupcad.gui_positive_infinity, popupcad.default_gui_rounding,self.support_out)
        ...
        v = StrictDoubleValidator(0, popupcad.gui_positive_infinity, popupcad.default_gui_rounding,self.hole_radius)
        ...
        v = StrictDoubleValidator(0, popupcad.gui_positive_infinity, popupcad.default_gui_rounding,self.cut_width)
