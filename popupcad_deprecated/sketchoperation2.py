...
class Dialog(qg.QDialog):
    ...
    def __init__(
        ...
        if selectedopindex is not None:
        ...
        self.operationtypeselector = OperationList(
            [],
            cls.function_names,
            cls.function_names)
...
class SketchOperation2(Operation):
    ...
    def editdata(
        ...
        function_name_mapping = dict(
            zip(self.operationtypes, self.function_names))
    ...
    def parentrefs(self):
        if self.operation_link1 is None:
            return []
        else:
    ...
    def buildeditdialog(self, design):
        ...
        if self.operation_link1 is not None:
    ...
    def upgrade(self, *args, **kwargs):
        ...
        if self.operation_link1 is None and self.function == 'union':
