...
class ScrapOperation(Operation):
    ...
    def generate(self, design):
        ...
        removable_both, removable_up, removable_down = removability.generate_removable_scrap(
            device, sheet, device_buffer=self.values[0] * popupcad.internal_argument_scaling)
    ...
    def upgrade(self, *args, **kwargs):
        ...
        operation_links = {
            'sheet': [
                (self.operation_links[0][0], self.operation_links[0][1])], 'device': [
                (self.operation_links[1][0], self.operation_links[1][1])]}
