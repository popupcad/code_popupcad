...
def return_formatted_time(specificity = 'second',small_separator='-',big_separator='_'):
    import time
    ...
    if specificity == 'year':
        ...
        b = '{0:04d}{ss}{1:02d}{ss}{2:02d}{bs}{3:02d}{ss}{4:02d}'.format(*args,**kwargs)
    elif specificity == 'second':
        b = '{0:04d}{ss}{1:02d}{ss}{2:02d}{bs}{3:02d}{ss}{4:02d}{ss}{5:02d}'.format(*args,**kwargs)
    return b