...
class ShiftFlip4(Operation2,LayerBasedOperation):
    name = 'Shift-Flip'

    def __init__(self, *args):
        super(ShiftFlip4, self).__init__()
        self.editdata(*args)
        self.id = id(self)

    def editdata(self, operation_links, shift, flip, rotate):
        super(ShiftFlip4, self).editdata(operation_links, {}, {})
        self.shift = shift
        self.flip = flip
        self.rotate = rotate
