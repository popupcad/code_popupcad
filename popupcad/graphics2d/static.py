...
class Static(Common):
    ...
    def __init__(self,generic,*args,**kwargs):
        ...
        pen = qg.QPen(qg.QColor.fromRgbF(*self.pen_color),self.linewidth,self.style,self.capstyle,self.joinstyle)  
        pen.setCosmetic(True)
        self.setPen(pen)
        brush = qg.QBrush(qg.QColor.fromRgbF(*self.brush_color),self.brushpattern) 
        self.setBrush(brush)
        self.refreshview()
        self.updateshape()
